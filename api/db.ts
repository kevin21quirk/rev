...
function getConnectionString() {
  ...
  if (!url) throw new Error('DATABASE_URL environment variable is not set in Vercel → Settings → Environment Variables')
  // Strip channel_binding param which some drivers don't support
...
async function ensureTables(sql: NeonQueryFunction<false, false>) {
  ...
  `
  // Seed transactions only when the table is empty
