    ...
    >
      ...
      <div className="px-2 py-3 border-t" style={{ borderColor: '#1e1e2c' }}>
        <button
          ...
          style={{
            backgroundColor: activeNav === 'Admin' ? 'rgba(239,68,68,0.15)' : 'transparent',
            color: activeNav === 'Admin' ? '#ef4444' : '#5c5c72',
          }}
          onMouseEnter={e => {
            if (activeNav !== 'Admin') {
              ;(e.currentTarget as HTMLElement).style.backgroundColor = 'rgba(239,68,68,0.08)'
              ;(e.currentTarget as HTMLElement).style.color = '#ef8888'
            }
          }}
          onMouseLeave={e => {
            if (activeNav !== 'Admin') {
              ;(e.currentTarget as HTMLElement).style.backgroundColor = 'transparent'
              ;(e.currentTarget as HTMLElement).style.color = '#5c5c72'
            }
          }}
        >
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
